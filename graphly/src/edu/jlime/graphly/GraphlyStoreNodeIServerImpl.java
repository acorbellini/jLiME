...
public class GraphlyStoreNodeIServerImpl extends RPCClient implements GraphlyStoreNodeI, Transferible {
 ...
 RPCDispatcher localRPC = RPCDispatcher.getLocalDispatcher(dest); if(localRPC!=null) 	this.local = (GraphlyStoreNodeI) localRPC.getTarget(targetID);
}
...
if(local!=null) {
   ...
   public TLongObjectHashMap getProperties(final String arg0, final String arg1, final int arg2, final TLongArrayList arg3)  throws Exception {
if(local!=null) {
		return local.getProperties(arg0,arg1,arg2,arg3);
}
    return (TLongObjectHashMap) disp.callSync(dest, client, targetID, "getProperties",new Object[] { arg0,arg1,arg2,arg3 });
  }
...
;
		return;}
    disp.callAsync(dest, client, targetID, "setDouble",new Object[] { arg0,arg1,arg2,arg3 });
  }
...
local.setTempProperties(arg0,arg1);
   ...
   public int getEdgeCount(final String arg0, final long arg1, final Dir arg2, final long[] arg3)  throws Exception {
if(local!=null) {
...
if(local!=null) {
   ...
   public GraphlyCount countEdges(final String arg0, final Dir arg1, final int arg2, final long[] arg3)  throws Exception {
if(local!=null) {
		return local.countEdges(arg0,arg1,arg2,arg3);
}
    return (GraphlyCount) disp.callSync(dest, client, targetID, "countEdges",new Object[] { arg0,arg1,arg2,arg3 });
  }
...
;
		return;}
    disp.callAsync(dest, client, targetID, "setDefaultDouble",new Object[] { arg0,arg1,arg2 });
  }
