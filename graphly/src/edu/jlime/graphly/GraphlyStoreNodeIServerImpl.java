...
public class GraphlyStoreNodeIServerImpl extends RPCClient implements
	...
	public void setProperty(final Long arg0, final String arg1,
		...
		if (local != null) {
			((GraphlyStoreNodeI) local.getTarget(targetID)).setProperty(arg0,
					arg1, arg2);
			return;
		}
	...
	public Object getProperty(final Long arg0, final String arg1)
			throws Exception {
		if (local != null) {
			return ((GraphlyStoreNodeI) local.getTarget(targetID)).getProperty(
					arg0, arg1);
		}
	...
	public void setProperties(final String arg0,
		...
		if (local != null) {
			((GraphlyStoreNodeI) local.getTarget(targetID)).setProperties(arg0,
					arg1);
			return;
		}
	...
	public void addInEdgePlaceholder(final Long arg0, final Long arg1,
		...
		if (local != null) {
			((GraphlyStoreNodeI) local.getTarget(targetID))
					.addInEdgePlaceholder(arg0, arg1, arg2);
			return;
		}
	...
	public void addEdge(final Long arg0, final Long arg1, final String arg2,
		...
		if (local != null) {
			((GraphlyStoreNodeI) local.getTarget(targetID)).addEdge(arg0, arg1,
					arg2, arg3);
			return;
		}
	...
	public Peer getJobAddress() throws Exception {
		...
		if (getJobAddressCached == null) {
			synchronized (this) {
				if (getJobAddressCached == null)
					getJobAddressCached = (Peer) disp.callSync(dest, client,
							targetID, "getJobAddress", new Object[] {});
	...
	public GraphlyCount countEdges(final Dir arg0, final Integer arg1,
			final long[] arg2) throws Exception {
		if (local != null) {
			return ((GraphlyStoreNodeI) local.getTarget(targetID)).countEdges(
					arg0, arg1, arg2);
		}
