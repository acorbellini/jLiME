...
public class GraphlyStoreNodeIBroadcastImpl implements GraphlyStoreNodeIBroadcast {
  ...
  public GraphlyStoreNodeIBroadcastImpl(RPCDispatcher disp, List<Peer> dest, Peer client, String targetID) {
   ...
   public void setDouble(final long arg0, final String arg1, final double arg2) throws Exception {
    disp.multiCallAsync( dest, client, targetID, "setDouble",new Object[] { arg0,arg1,arg2 });
  }

   public void setDefault(final String arg0, final Object arg1) throws Exception {
    disp.multiCall( dest, client, targetID, "setDefault",new Object[] { arg0,arg1 });
  }
   ...
   public Map<Peer,Double>  getDefaultDouble(final String arg0) throws Exception {
    return disp.multiCall( dest, client, targetID, "getDefaultDouble",new Object[] { arg0 });
  }
   ...
   public void setDefaultDouble(final String arg0, final double arg1) throws Exception {
    disp.multiCallAsync( dest, client, targetID, "setDefaultDouble",new Object[] { arg0,arg1 });
  }
