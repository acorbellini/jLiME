...
public class GraphlyStoreNodeIBroadcastImpl implements GraphlyStoreNodeIBroadcast {
  ...
  public Map<Peer,TLongObjectHashMap>  getProperties(final String arg0, final TLongArrayList arg1) throws Exception {
  ...
  public Map<Peer,TLongIntHashMap>  countEdges(final Dir arg0, final long[] arg1) throws Exception {
    return disp.multiCall( dest, client, targetID, "countEdges",new Object[] { arg0,arg1 });
  }
