...
public class Recommendation extends CustomTraversal {
	...
	public Recommendation(Traversal tr) {
		super(tr);
	}
	...
	public Recommendation hitsPregel(String auth, String hub, int steps, int top) throws Exception {
	...
	public Recommendation salsaPregel(String auth, String hub, int steps, int top) throws Exception {
	...
	public CustomTraversal katz(String val, int steps, float beta, Dir dir) throws Exception {
	...
	public CustomTraversal friendLinkPregel(String k, int depth, Dir dir) throws Exception {
		long vertices = tr.getGraph().getVertexCount();
	...
	public CustomTraversal friendLinkHybrid(int top, int depth, Dir dir) throws Exception {
		long vertices = tr.getGraph().getVertexCount();

		Dir[] dirs = new Dir[depth];
		Arrays.fill(dirs, dir);
		tr.customStep(new BetaCountHybrid(new FriendLinkBeta(vertices), top, "fl", dirs));
	...
	public CustomTraversal katzHybrid(float beta, int depth, int top, Dir dir) {
		...
		tr.customStep(new BetaCountHybrid(new KatzBeta(beta), top, "katz", dirs));
		return this;
	}
	...
	public CustomTraversal salsaHybrid(String auth, String hub, int steps, int top) {
		tr.customStep(new SalsaHybrid(auth, hub, steps * 2, top));
		return this;
	}

	public CustomTraversal hitsHybrid(String auth, String hub, int steps, int top) {
