...
if(localRPC!=null) {
   ...
   public GraphlyCount countEdges(final String arg0, final Dir arg1, final int arg2, final TLongFloatHashMap arg3)  throws Exception {
if(localRPC!=null) {
		return getLocal().countEdges(arg0,arg1,arg2,arg3);
}
...
public GraphlyStoreNodeI getLocal() throws Exception {	if(local==null){		synchronized(this){			if(local==null){				this.local = (GraphlyStoreNodeI							  ) localRPC.getTarget(targetID);
			}		}}
return this.local;
}
}