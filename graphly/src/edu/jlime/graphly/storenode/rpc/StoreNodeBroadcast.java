...
import edu.jlime.core.cluster.BroadcastException;import edu.jlime.graphly.storenode.rpc.StoreNode;
...
public interface StoreNodeBroadcast { 
   ...
   public Map<Peer,TLongObjectMap>  getAllEdges(final String arg0, final TLongArrayList arg1, final Dir arg2) throws Exception; 
