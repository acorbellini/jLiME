...
public interface StoreNode {
	...
	public abstract Count countEdges(String graph, Dir dir, int max_edges,
			long[] data, float[] values, long[] toFilter) throws Exception;
	...
	public abstract void setProperties(String graph, String to,
			TLongObjectMap<Object> submap) throws Exception;

	public abstract TLongObjectMap<Object> getProperties(String graph, String k,
			int top, TLongArrayList value) throws Exception;
