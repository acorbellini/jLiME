...
public class GraphlyStoreNodeIBroadcastImpl implements StoreNodeBroadcast {
	...
	public GraphlyStoreNodeIBroadcastImpl(RPC disp, List<Peer> dest, Peer client, String targetID) {
		this.disp = disp;
	...
	public Map<Peer, Float> getFloat(final String arg0, final long arg1, final String arg2, final float arg3)
			throws Exception {
	...
	public Map<Peer, TLongObjectHashMap> getProperties(final String arg0, final String arg1, final int arg2,
	...
	public Map<Peer, Integer> getEdgeCount(final String arg0, final long arg1, final Dir arg2, final TLongHashSet arg3)
			throws Exception {
	...
	public Map<Peer, Object> getEdgeProperty(final String arg0, final long arg1, final long arg2, final String arg3,
	...
	public Map<Peer, long[]> getEdges(final String arg0, final Dir arg1, final int arg2, final long[] arg3)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getEdges", new Object[] { arg0, arg1, arg2, arg3 });
	}

	public Map<Peer, Count> countEdges(final String arg0, final Dir arg1, final int arg2, final long[] arg3,
			final float[] arg4, final long[] arg5) throws Exception {
	...
	public Map<Peer, Long> getRandomEdge(final String arg0, final long arg1, final long[] arg2, final Dir arg3)
			throws Exception {
	...
	public Map<Peer, TLongArrayList> getVertices(final String arg0, final long arg1, final int arg2, final boolean arg3)
			throws Exception {
	...
	public void setTempFloats(final String arg0, final String arg1, final boolean arg2, final TLongFloatHashMap arg3)
			throws Exception {
		disp.multiCall(dest, client, targetID, "setTempFloats", new Object[] { arg0, arg1, arg2, arg3 });
	}
