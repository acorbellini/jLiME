...
public class GraphlyStoreNodeIBroadcastImpl implements
	...
	public Map<Peer, Object> getProperty(final String arg0, final long arg1,
			final String arg2) throws Exception {
		return disp.multiCall(dest, client, targetID, "getProperty",
				new Object[] { arg0, arg1, arg2 });
	}

	public Map<Peer, Float> getFloat(final String arg0, final long arg1,
			final String arg2) throws Exception {
		return disp.multiCall(dest, client, targetID, "getFloat", new Object[] {
				arg0, arg1, arg2 });
	}

	public Map<Peer, Double> getDouble(final String arg0, final long arg1,
			final String arg2) throws Exception {
		return disp.multiCall(dest, client, targetID, "getDouble",
				new Object[] { arg0, arg1, arg2 });
	}

	public Map<Peer, Object> getDefault(final String arg0, final String arg1)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getDefault",
	...
	public Map<Peer, Map> getProperties(final String arg0, final long[] arg1,
			final String[] arg2) throws Exception {
		return disp.multiCall(dest, client, targetID, "getProperties",
				new Object[] { arg0, arg1, arg2 });
	}
	...
	public void setTempProperties(
			...
			throws Exception {
		disp.multiCall(dest, client, targetID, "setTempProperties",
				new Object[] { arg0, arg1 });
	}

	public Map<Peer, Object> getEdgeProperty(final String arg0,
			final long arg1, final long arg2, final String arg3,
	...
	public void setDefaultDouble(final String arg0, final String arg1,
		...
		disp.multiCall(dest, client, targetID, "setDefaultDouble",
				new Object[] { arg0, arg1, arg2 });
	}

	public void setDefaultFloat(final String arg0, final String arg1,
			final float arg2) throws Exception {
		disp.multiCall(dest, client, targetID, "setDefaultFloat", new Object[] {
				arg0, arg1, arg2 });
	}
	...
	public Map<Peer, Float> getDefaultFloat(final String arg0, final String arg1)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getDefaultFloat",
				new Object[] { arg0, arg1 });
	}

	public Map<Peer, Object> gather(final String arg0, final Gather<?> arg1)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "gather", new Object[] {
				arg0, arg1 });
	}
	...
	public void removeVertex(final String arg0, final long arg1)
			throws Exception {
		disp.multiCall(dest, client, targetID, "removeVertex", new Object[] {
				arg0, arg1 });
	}

	public Map<Peer, String> getLabel(final String arg0, final long arg1)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getLabel", new Object[] {
				arg0, arg1 });
	}

	public Map<Peer, Integer> getVertexCount(final String arg0)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getVertexCount",
				new Object[] { arg0 });
	}

	public Map<Peer, TLongArrayList> getVertices(final String arg0,
			final long arg1, final int arg2, final boolean arg3)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getVertices",
				new Object[] { arg0, arg1, arg2, arg3 });
	}

	public Map<Peer, Long> getRandomEdge(final String arg0, final long arg1,
	...
	public Map<Peer, Set> getGraphs() throws Exception {
		return disp.multiCall(dest, client, targetID, "getGraphs",
				new Object[] {});
	}

	public Map<Peer, Integer> getEdgeCount(final String arg0, final long arg1,
			final Dir arg2, final long[] arg3) throws Exception {
	...
	public void addVertex(final String arg0, final long arg1, final String arg2)
			throws Exception {
		disp.multiCallAsync(dest, client, targetID, "addVertex", new Object[] {
				arg0, arg1, arg2 });
	}

	public Map<Peer, GraphlyCount> countEdges(final String arg0,
			final Dir arg1, final int arg2, final long[] arg3) throws Exception {
		return disp.multiCall(dest, client, targetID, "countEdges",
				new Object[] { arg0, arg1, arg2, arg3 });
	}

	public Map<Peer, Double> getDefaultDouble(final String arg0,
			final String arg1) throws Exception {
		return disp.multiCall(dest, client, targetID, "getDefaultDouble",
				new Object[] { arg0, arg1 });
	}

	public Map<Peer, long[]> getEdges(final String arg0, final Dir arg1,
	...
	public void commitUpdates(final String arg0, final String[] arg1)
			throws Exception {
		disp.multiCall(dest, client, targetID, "commitUpdates", new Object[] {
				arg0, arg1 });
	}
