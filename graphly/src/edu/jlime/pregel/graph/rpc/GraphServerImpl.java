...
public class GraphServerImpl extends RPCClient implements PregelGraph, Transferible {

	transient RPC localRPC;
	transient volatile PregelGraph local = null;

	public GraphServerImpl(RPC disp, Peer dest, Peer client, String targetID) {
