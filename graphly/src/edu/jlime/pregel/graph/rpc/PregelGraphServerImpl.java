...
public class PregelGraphServerImpl extends RPCClient implements PregelGraph, Transferible {

   transient RPC localRPC;
   transient volatile PregelGraph local = null;
  public PregelGraphServerImpl(RPC disp, Peer dest, Peer client, String targetID) {
...
if(localRPC!=null) {
   ...
   public float getFloat(final String arg0, final long arg1, final float arg2)  throws Exception {
if(localRPC!=null) {
...
if(localRPC!=null) {
    ...
    return (float) disp.callSync(dest, client, targetID, "getFloat",new Object[] { arg0,arg1 });
  }

   public double getDouble(final long arg0, final String arg1)  throws Exception {
if(localRPC!=null) {
		return getLocal().getDouble(arg0,arg1);
}
    return (double) disp.callSync(dest, client, targetID, "getDouble",new Object[] { arg0,arg1 });
  }
...
getLocal().setDouble(arg0,arg1,arg2);
		return;}
    disp.callSync(dest, client, targetID, "setDouble",new Object[] { arg0,arg1,arg2 });
  }
...
getLocal().setFloat(arg0,arg1,arg2);
		return;}
    disp.callSync(dest, client, targetID, "setFloat",new Object[] { arg0,arg1,arg2 });
  }
...
if(localRPC!=null) {
    ...
    return (float) disp.callSync(dest, client, targetID, "getDefaultFloat",new Object[] { arg0 });
  }
...
if(localRPC!=null) {
    ...
    return (int) disp.callSync(dest, client, targetID, "getNeighbourhoodSize",new Object[] { arg0 });
  }
...
if(localRPC!=null) {
    ...
    return (TLongHashSet) disp.callSync(dest, client, targetID, "getNeighbours",new Object[] { arg0 });
  }
...
if(localRPC!=null) {
    ...
    return (TLongHashSet) disp.callSync(dest, client, targetID, "getOutgoing",new Object[] { arg0 });
  }
...
getLocal().disableOutgoing(arg0,arg1);
   ...
   public TLongHashSet getAdjacents(final long arg0, final Dir arg1)  throws Exception {
if(localRPC!=null) {
		return getLocal().getAdjacents(arg0,arg1);
}
    return (TLongHashSet) disp.callSync(dest, client, targetID, "getAdjacents",new Object[] { arg0,arg1 });
  }
...
if(localRPC!=null) {
    ...
    return (TLongHashSet) disp.callSync(dest, client, targetID, "getIncoming",new Object[] { arg0 });
  }
...
if(localRPC!=null) {
    ...
    return (boolean) disp.callSync(dest, client, targetID, "isLocal",new Object[] { arg0 });
  }
...
public PregelGraph getLocal() throws Exception {	if(local==null){		synchronized(this){			if(local==null){				this.local = (PregelGraph							  ) localRPC.getTarget(targetID);
			}		}}
return this.local;
}
}