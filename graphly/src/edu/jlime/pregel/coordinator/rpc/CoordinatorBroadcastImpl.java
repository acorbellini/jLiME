...
public class CoordinatorBroadcastImpl implements CoordinatorBroadcast {
  ...
  public CoordinatorBroadcastImpl(RPC disp, List<Peer> dest, Peer client, String targetID) {
   ...
   public void error(final Exception arg0, final int arg1, final UUID arg2) throws Exception {
    disp.multiCallAsync( dest, client, targetID, "error",new Object[] { arg0,arg1,arg2 });
  }
