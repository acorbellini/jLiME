...
public class CoordinatorServer {
	...
	public CoordinatorServer(RPC rpc) throws Exception {

		this.workers = rpc.manage(new WorkerFactory(rpc, WorkerServer.WORKER_KEY), new PeerFilter() {
		...
		rpc.registerTarget(COORDINATOR_KEY, new CoordinatorImpl(rpc, workers), true);
	...
	private static CoordinatorServer build() throws Exception {
		...
		RPC rpc = new JLiMEFactory(config, data, new PeerFilter() {
