...
public interface Worker {
	...
	@Sync
	public void sendFloatArrayMessage(String msgType, long l, long[] vids, float[][] data, int taskid) throws Exception;

	@Sync
	public void sendFloatArrayBroadcastMessage(String msgtype, long from, float[] value, int taskid) throws Exception;

	@Sync
	public void sendObjectsMessage(String msgType, long[] from, long[] vids, Object[] objects, int taskid)
			throws Exception;
