...
getLocal().sendBroadcastMessageSubgraphFloat(arg0,arg1,arg2,arg3,arg4);
		return;}
    disp.callSync(dest, client, targetID, "sendBroadcastMessageSubgraphFloat",new Object[] { arg0,arg1,arg2,arg3,arg4 });
  }
...
getLocal().sendFloatArrayBroadcastMessage(arg0,arg1,arg2,arg3);
		return;}
    disp.callSync(dest, client, targetID, "sendFloatArrayBroadcastMessage",new Object[] { arg0,arg1,arg2,arg3 });
  }

   public void finishedProcessing(final int arg0)  throws Exception {
if(localRPC!=null) {
getLocal().finishedProcessing(arg0);
		return;}
    disp.callSync(dest, client, targetID, "finishedProcessing",new Object[] { arg0 });
  }
...
getLocal().sendBroadcastMessageSubgraph(arg0,arg1,arg2,arg3,arg4);
		return;}
    disp.callSync(dest, client, targetID, "sendBroadcastMessageSubgraph",new Object[] { arg0,arg1,arg2,arg3,arg4 });
  }
...
public Worker getLocal() throws Exception {	if(local==null){		synchronized(this){			if(local==null){				this.local = (Worker							  ) localRPC.getTarget(targetID);
			}		}}
return this.local;
}
}