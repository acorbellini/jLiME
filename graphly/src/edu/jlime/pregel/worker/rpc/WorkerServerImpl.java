...
public class WorkerServerImpl extends RPCClient implements Worker, Transferible {
	...
	public void sendFloatMessage(final UUID arg0, final String arg1, final long arg2, final long[] arg3,
			final float[] arg4, final int arg5) throws Exception {
		if (localRPC != null) {
			getLocal().sendFloatMessage(arg0, arg1, arg2, arg3, arg4, arg5);
			return;
		}
		disp.callSync(dest, client, targetID, "sendFloatMessage", new Object[] { arg0, arg1, arg2, arg3, arg4, arg5 });
	}

	public void sendFloatMessage(final UUID arg0, final String arg1, final long arg2, final long arg3, final float arg4,
