...
public class PingDiscovery extends Discovery {
	...
	public PingDiscovery(JLiMEAddress local, String name,
			MessageProcessor unicast, Configuration opts, int port,
	...
	private void sendDiscoveryMessage(String addrToLookFor, int p)
		...
		msg.setTo(new SocketAddress(JLiMEAddress.noAddr(),
				new InetSocketAddress(InetAddress.getByName(addrToLookFor), p),
				AddressType.ANY));
