...
public class WorkerBroadcastImpl implements WorkerBroadcast {
	...
	public Map<Peer, PregelGraph> getResult(UUID arg0) throws Exception {
		return disp.multiCall(dest, client, targetID, "getResult",
				new Object[] { arg0 });
	}
	...
	public void sendDataToVertex(Vertex arg0, Vertex arg1, VertexData arg2,
		...
		disp.multiCall(dest, client, targetID, "sendDataToVertex",
				new Object[] { arg0, arg1, arg2, arg3 });
	}

	public void nextSuperstep(Integer arg0, UUID arg1) throws Exception {
		disp.multiCallAsync(dest, client, targetID, "nextSuperstep",
