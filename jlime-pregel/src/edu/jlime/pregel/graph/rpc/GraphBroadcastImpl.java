...
public class GraphBroadcastImpl implements GraphBroadcast {
	...
	public GraphBroadcastImpl(RPCDispatcher disp, List<Peer> dest, Peer client,
			String targetID) {
		this.disp = disp;
	...
	public Map<Peer, Object> get(final long arg0, final String arg1)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "get", new Object[] {
				arg0, arg1 });
	}
	...
	public Map<Peer, String> getName() throws Exception {
		return disp.multiCall(dest, client, targetID, "getName",
				new Object[] {});
	}
	...
	public Map<Peer, Object> getDefaultValue(final String arg0)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getDefaultValue",
				new Object[] { arg0 });
	}

	public void setVal(final long arg0, final String arg1, final Object arg2)
			throws Exception {
		disp.multiCall(dest, client, targetID, "setVal", new Object[] { arg0,
				arg1, arg2 });
	}
	...
	public void disableOutgoing(final long arg0, final long arg1)
			throws Exception {
		disp.multiCall(dest, client, targetID, "disableOutgoing", new Object[] {
				arg0, arg1 });
	}

	public Map<Peer, Boolean> createVertex(final long arg0) throws Exception {
		return disp.multiCall(dest, client, targetID, "createVertex",
				new Object[] { arg0 });
	}

	public Map<Peer, TLongArrayList> getOutgoing(final long arg0)
			throws Exception {
		return disp.multiCall(dest, client, targetID, "getOutgoing",
				new Object[] { arg0 });
	}

	public Map<Peer, Iterable> vertices() throws Exception {
		return disp.multiCall(dest, client, targetID, "vertices",
				new Object[] {});
	}

	public Map<Peer, Integer> getOutgoingSize(final long arg0) throws Exception {
		return disp.multiCall(dest, client, targetID, "getOutgoingSize",
				new Object[] { arg0 });
	}

	public void disableIncoming(final long arg0, final long arg1)
			throws Exception {
		disp.multiCall(dest, client, targetID, "disableIncoming", new Object[] {
				arg0, arg1 });
	}
