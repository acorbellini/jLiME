...
public class GraphServerImpl extends RPCClient implements Graph, Transferible {
 ...
 RPCDispatcher localRPC = RPCDispatcher.getLocalDispatcher(dest); if(localRPC!=null) 	this.local = (Graph) localRPC.getTarget(targetID);
}
...
;
		return;}
    disp.callAsync(dest, client, targetID, "setDouble",new Object[] { arg0,arg1,arg2 });
  }
...
if(local!=null) {
    ...
    return (TLongArrayList) disp.callSync(dest, client, targetID, "getOutgoing",new Object[] { arg0 });
  }
...
if(local!=null) {
    ...
    return (TLongArrayList) disp.callSync(dest, client, targetID, "getIncoming",new Object[] { arg0 });
  }
