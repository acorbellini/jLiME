...
public class CoordinatorServerImpl extends RPCClient implements Coordinator {
	...
	public PregelExecution execute(VertexFunction arg0, PregelConfig arg1,
			Peer arg2) throws Exception {
		if (local != null) {
			return ((Coordinator) local.getTarget(targetID)).execute(arg0,
					arg1, arg2);
		}
	...
	public Double getAggregatedValue(UUID arg0, Long arg1, String arg2)
			throws Exception {
		if (local != null) {
			return ((Coordinator) local.getTarget(targetID))
					.getAggregatedValue(arg0, arg1, arg2);
		}
		return (Double) disp.callSync(dest, client, targetID,
				"getAggregatedValue", new Object[] { arg0, arg1, arg2 });
	}

	public void setAggregatedValue(UUID arg0, Long arg1, String arg2,
			Double arg3) throws Exception {
		if (local != null) {
			((Coordinator) local.getTarget(targetID)).setAggregatedValue(arg0,
					arg1, arg2, arg3);
			return;
		}
	...
	public void finished(final UUID arg0, final UUID arg1, final Boolean arg2) throws Exception {
		if (local != null) {
			async.execute(new Runnable() {
				public void run() {
					try {
						((Coordinator) local.getTarget(targetID)).finished(
								arg0, arg1, arg2);
					} catch (Exception e) {
						e.printStackTrace();
					}
