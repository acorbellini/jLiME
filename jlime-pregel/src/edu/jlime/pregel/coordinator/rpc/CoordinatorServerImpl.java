...
public class CoordinatorServerImpl extends RPCClient implements Coordinator {
 ...
 super(disp, dest, client, targetID);
  ...
  public PregelGraph execute(List arg0, VertexFunction arg1)  throws Exception {
    return (PregelGraph) disp.callSync(dest, client, targetID, "execute",new Object[] { arg0,arg1 });
  }
